...
public class Helper {
    ...
    // Метод ожидает появления элемента на странице
    public static ViewAction waitForViewElement(final Matcher<View> viewMatcher, final long millis) {
    ...
    public static ViewAction waitId(final int viewId, final long millis) {
        return waitForViewElement(withId(viewId), millis);
    }


    // Метод позволяет извлечь строку по идентификатору ресурса
    ...
    // Метод позволяет получить текст из элемента новостей по позиции
    ...
    // Метод для выбора случайной категории из списка
    ...
    // Метод генерирует строку (число длинной в 3 символа)
    ...
    // Параметр days будет положительным для будущей даты или отрицательным для прошедшей
    ...
    // Метод позволяет получить текущее время
    ...
    // Mетод позволяет выставить таймаут в тестах
